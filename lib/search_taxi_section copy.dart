...
class _SearchTaxiSectionState extends State<SearchTaxiSection> {
  Future<void> fetchData(String placa) async {
    final url = Uri.parse(
        'https://grupoempresarialdts.com/appdataservip/json_vehiculo_qr.php?placa=$placa');
        ...
        children: [
              ...
              children: [
                Padding(
                  ...
                  child: const Image(
                    ...
                    image:
                        AssetImage('public/assets/images/logo-checkpoint.png'),
                  ),
                ),
                Card(
          ...
          Align(
            ...
            child: CarouselSlider(
              disableGesture: true,
              items: [
                Image.asset('public/assets/images/bann1.jpg', fit: BoxFit.fill),
                Image.asset('public/assets/images/bann2.jpg', fit: BoxFit.fill),
              ],
